...
function SellWithUsInfo() {
    return (
        <div className='container'>
            <div className="row justify-content-md-center mt-3">
                < div className="col-12 col-md-12 col-lg-5 bg-light mt-5 me-4 p-5 border">

                <p className="h6 row justify-content-md-center mt-3">LET’S GET STARTED</p>
                <p className=" h1 row justify-content-md-center mt-3">Sell with us. It's easy.</p>
                    
                
                <div className="row justify-content-md-center mt-3">Let’s start with a little info about you.</div>
