...
function SellWithUsDirectDepositVerify() {
    return (
        <div className='container w-100 h-100 p-5 '>
            <main>
                <div>
                    <a> <MdOutlineArrowBackIos className="btn-group btn-group-left" size={25} />
                        <strong>TO PAYMENT OPTIONS</strong></a>
                    <div className='container w-50 h-100'>
                            ...
                            <h6 className="  text-left mt-3">
                                ...
                                associated with your The RealReal account. Please enter it below to update your Payment Option.</h6>
                            <br></br>
                        </div>
                        <div className=" container w-50 h-25 p-1">
                            ...
                            <div className=" container w-100 h-25 p-1">
                                <Link to={"/sellWithUs/DirectDeposit"}>
                                    <button type="button" className="btn btn-outline-dark w-100 ">Verify</button>
                                </Link>
                            </div>
                            <br></br>

                            <h6 className=" text-center "><u>Resend One-Time Password</u></h6>
...
export default SellWithUsDirectDepositVerify
